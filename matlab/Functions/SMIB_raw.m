function [Y_network1,Y_line1,Y_TR1,nodes_from_r,nodes_to_r,Line_RX,Load_P,Load_Q,Line_R,Line_L,Line_C,Line_length] = SMIB_raw(wb,Sb,Zb_lines,Lb_lines,modif)
