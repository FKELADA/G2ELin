...
model.name             = ['Simulink_file_name_of_the_corresponding_network'];  % The simulink file name
Dynamic_sim            = 1; %yes=1, no=0 
ss_analysis            = 0; %yes=1, no=0
% Only in case of dynamic_simulations:
reinit_LF              = 1; % In case you want to run Simulink loadflow only: 1: run load flow in simulink for initialisations 
runSim                 = 0; % run the simulation directly when you run this script
% analysis:
Participation          = 0; single_mode = 0; mode_participation   = 23;
EigenVal_Plot          = 0; Balance_option = 'nobalance';
mode_shape             = 0; mode_mshape          = 23;
sensitivity            = 0; mode_sensitivity     = 23;
step_resp              = 0; input     = "P^*_{SG_1}"; output    = "p_e_s"; StepM = 0.1; %You can check all inputs and outputs in the variables: inputNames and outputNames
Free_motion            = 0; free_resp_state = "\Delta \omega_r_s";
%% ========================================================================
...
%----------------------------------------------------------%
% The Y_DER matrix describes the nodes to which DER units are connected:
% where?: describes to which node it is interfaced, DG-Type:describes the
% type of the DER: (1) infinite bus, (2) VSC-GFM, (3) SC-GFL, (4) SM.
% Bus tyoe: load flow node type: (1) slack, (2) PV, (3) PQ
% TR_R and TR_XL describes the interconnecting transformer impedance while
% Xd is the SM equivalent transient impedance used for SCR calculations. 
